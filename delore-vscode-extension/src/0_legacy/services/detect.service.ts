...
import { ActiveModelSetting } from '../../constants/config';
import { safeJsonParse, safeJsonStringify } from '../../utils/typeSafeJson';
import { isDetectionModelOutput } from '../../type/state.type';
import {
  Either,
  isLeft,
  makeLeft,
...
export const detectionService = (
  ...
  activeDetectionModels.forEach((detectionModel) => {
    ...
    funcs.forEach(async (func) => {
      ...
      const detectionOutputEither = executePythonCommandSyncService(
        absPathToBinary,
        absPathToScript,
        params,
        absPathToCwd
